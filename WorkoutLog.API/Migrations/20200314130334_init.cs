        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogsWeight = table.Column<bool>(nullable: false),
                    LogsSets = table.Column<bool>(nullable: false),
                    LogsReps = table.Column<bool>(nullable: false),
                    LogsTime = table.Column<bool>(nullable: false),
                    LogsDistance = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sets = table.Column<byte>(nullable: false),
                    Reps = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogTypeId = table.Column<int>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_LogTypes_LogTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Goals_Volumes_VolumeId",
                        column: x => x.VolumeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Logs_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Goals_VolumeId",
                table: "Goals",
                column: "VolumeId");

            migrationBuilder.CreateIndex(
                name: "IX_Logs_ExerciseId",
                table: "Logs",
                column: "ExerciseId");
